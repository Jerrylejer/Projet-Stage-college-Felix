...
const Header = () => {
  return (
    <div className='text-blue-200 flex flex-col font-bold mt-6 md:text-5xl md:mt-4'>
        ...
        <p className='text-xl mb-10 text-justify'>Je suis à la recherche d'une semaine de stage dans un cabinet d'architecte <span className='underline text-2xl'>du 13 au 18 février 2023</span>.</p>
